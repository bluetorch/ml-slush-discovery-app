    ...
    function Config(
        ...
        $stateProvider
            ...
            .state('root.search', {
                ...
                controllerAs: 'ctrl',
                resolve: {
                    constraints: function(ServerConfig) {
                        return ServerConfig.getSearchOptions().then(function(response) {
                            var constraints = {};
                            response.options.constraint.forEach(function(constraint) {
                                if (constraint.range && constraint.range.element) {
                                    constraints[constraint.name] = constraint.range.element.name;
                                }
                            });
                            return constraints;
                        });
                ...
                resolve: {
                    doc: function(MLRest, $stateParams) {
                        ...
                        return MLRest
                            .getDocument(uri, {
                                format: 'json',
                                transform: 'data-to-html-display'
                            })
